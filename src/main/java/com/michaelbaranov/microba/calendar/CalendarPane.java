...
public class CalendarPane extends JComponent {
   ...
   * @throws PropertyVetoException if the date is restricted by the current {@link VetoPolicy}.
   * @see #getVetoPolicy()
   ...
   * date).
   *
   * @param visible <code>true</code> to show the none-button <code>false</code>
   *                to hide
   */
   ...
   *
   * @param commit <code>true</code> to indicate commit, <code>false</code>
   *               to indicate revert
   * @see CommitEvent
   * @see CommitListener
   */
